...
\begin{enumerate}[(a)]
    ...
    \item LHS: A concert has n-distinct people attending. The concert is giving away k-guitars. Of the k-guitars a small subset of size j are signed. Each person can only receive one guitar and each guitar can only be signed once. How many different ways can the signed guitars be distributed?
    \end{enumerate}
