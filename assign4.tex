...
\end{minted}
\end{problem}
Yeah, this is some garbage code for show.
...
\begin{align*}
    ...
    x_0 & = 1
\end{align*}
Express the solution $a,b,c,d,e$ in terms of numbers studied in this section. Use linear algerbra and formulas for expanding the coefficients.
\end{problem}
