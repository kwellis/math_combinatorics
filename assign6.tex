...
\begin{enumerate}[(a)]
    ...
    \end{equation*}
    We alredy have $N_{=}(\emptyset)$ from part b. We now need to compute $N_{=}(1)$ and add it to part b. This can be done with the general inclusion-exclusion formula. Where:
    \begin{equation*}
        N_{=}(S) = \sum_{J: S \subseteq J \subseteq P} (-1)^{|J|-|S|} N_{\ge}(J)
    \end{equation*}
    The big thing that occurs is because of the addition of $|S|$ the signs of $+$ or $-$ swap. So we have.
    \begin{equation*}
        N_{=}(1) = (1650 + 2310 + 1260 + 4004) - (720 + 700 + 1260 + 720) + 400 = 6224
    \end{equation*}
\end{enumerate}
