...
\textbf{Answer:} To get from $A$ to $B$ requires moving across $16$ points. Each one of those points you can make two decisions, either move right $1$ or move up $0$. To reach your desired endpoint requires you to make exactly $10$ right moves or exactly $6$ up moves. So you have this many paths to choose from:
\begin{equation*}
