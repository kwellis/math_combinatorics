...
\begin{enumerate}[(a)]
    ...
    N_{\ge}(I_b I_d) = \binom{5}{4}\binom{14-5}{9-4}\binom{16-14}{10-9} = 1260 \quad \quad & N_{\ge}(I_c I_d) = \binom{9}{7}\binom{14-9}{9-7}\binom{16-14}{10-9} = 720
    \end{align*}
    ...
    \end{equation*}
    \item Use Thm 3.1.5, I feel like you start with $8008$ again, but we aren't taking away the single intersections? Just the doubles and above? Where $|S| = 1$.
    \begin{equation*}
        (-1)^{0-1}*8008 + (-1)^{1-1}*(1650 + 2310 + 1260 + 4004) = -8008 + 9224 = 1216
    \end{equation*}
\end{enumerate}
