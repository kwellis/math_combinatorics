...
\begin{enumerate}[(a)]
    ...
    \end{equation*}
    \item Need to describe the four congested intersections. They will be described as the total number of moves and number of right moves.
    \begin{enumerate}[(i)]
        \item $I_a :=$ Total: $5$ and rights: $2$, Math $\binom{5}{2} = 10$
        \item $I_b :=$ Total: $5$ and rights: $4$, Math $\binom{5}{4} = 5$
        \item $I_c :=$ Total: $9$ and rights: $7$, Math $\binom{9}{7} = 36$
        \item $I_d :=$ Total: $14$ and rights: $9$, Math $\binom{14}{9} = 2002$ 
    \end{enumerate}
    It is impossible to land on both $I_a$ and $I_b$ in a single drive because it takes $5$ moves to land on either one. The set $P = \{I_a, I_b, I_c, I_d\}$ and the possible subsets are:
    \begin{equation*}
        J = \{\emptyset, \{I_a\}, \{I_b\}, \{I_c\}, \{I_d\}, \{I_aI_c\}, \{I_aI_d\}, \{I_bI_c\}, \{I_bI_d\}, \{I_cI_d\}, \{I_a I_c I_d\}, \{I_b I_c I_d\}\}
    \end{equation*}
    As seen, no subset with both $I_a I_b$ is occuring inside $J$.
    \begin{equation*}
\begin{aligned}
    N_{=}(\emptyset) ={}& 8008 - (10 + 5 + 36 + 2002) + (10 \cdot 36 + 10 \cdot 2002 + 5 \cdot 36 + 5\cdot 2002 + 36 \cdot 2002) \\
    & - (10 \cdot 36 \cdot 2002 + 5 \cdot 36 \cdot 2002)
\end{aligned}
\end{equation*}
    \item Rawr
\end{enumerate}
